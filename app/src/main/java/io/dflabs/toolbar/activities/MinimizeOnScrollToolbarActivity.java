...
public class MinimizeOnScrollToolbarActivity extends BaseActivity implements RecyclerClickItemListener{

    @Bind(R.id.act_hide_recycler)
    RecyclerView mRecyclerView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_minimize_toolbar);
